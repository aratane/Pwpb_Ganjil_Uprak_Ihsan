...
<body>
    <from action="proseskendaraan.php" method="POST">
        ...
        <table align="center">
            ...
            <tr>
                ...
                <td>
                    <select name="nmpemilik">
                        ...
                        while ($row = mysqli_fetch_array($query)){; ?> <option value="<?php echo $row['KD_Pemilik'] ?>"><?php echo $row['Nama_Pemilik'] ?></option>?><?php } ?>
                    </select>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td align="right">
                    <input type="submit" value="simpan" name="simpan"s>
                </td>
            </tr>
        </table>
</form>
